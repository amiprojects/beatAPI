		...
		<div data-role="main">
			<div style="width: 64%; float: left; padding: 30px 18%;">
				<div style="width: 100%; float: left;">
					...
					<div style="width: 40%; float: left; text-align: center; color: #0089c7; font-weight: bold; font-size: 2vw;">
					WEEKLY LEADERBOARD
					</div>
					<hr style="width: 30%;float: left;height: 2px;margin-top: 13px;background-color: #0089c7;border: none;border-color: #0089c7;">
				</div>
				...
				<div style="width: 100%; float: left; padding: 50px 0%; border-bottom: 1px solid #e4e4e4;" id="top3score">
					...
					<div style="width: 32.33%;float:left;margin-right:5px;">
						<div style="width: 200px;float: left;margin-bottom: 20px;background: url('images/position.png');background-size: 100% 100%;min-height: 200px;min-width: 200px;background-repeat: no-repeat;">
							<img src="images/2nd_batch.png" style="width: 230px;float: left;position: absolute;z-index: 2;top: 24.5%;">
						</div>
						<div style="width: 100%; float: left;text-align: center;">
							<div style="width: 100%; float: left;color: #0089c7; font-weight: bold; font-size: 16px; text-transform: uppercase;">
								678 HITS
					...
					<div style="width: 32.33%;float:left;margin-right:5px;">
						<div style="width: 200px;float: left;margin-bottom: 20px;background: url('images/position.png');background-size: 100% 100%;min-height: 200px;min-width: 200px;background-repeat: no-repeat;">
							<img src="images/3rd_batch.png" style="width: 230px;float: left;position: absolute;z-index: 2;top: 24.5%;">
						</div>
						<div style="width: 100%; float: left;text-align: center;">
							<div style="width: 100%; float: left;color: #0089c7; font-weight: bold; font-size: 16px; text-transform: uppercase;">
								678 HITS
				...
				<div style="width: 100%; float: left; border-bottom: 1px solid #e4e4e4;">
					<div style="width: 46%; float: left; padding: 2%; text-align: left; font-weight: bold; color: #0089c7;">
						NAME
					</div>
					<div style="width: 46%; float: left; padding: 2%; text-align: right; font-weight: bold; color: #0089c7;">
						SCORE
					</div>
				</div>
