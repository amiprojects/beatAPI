...
<div data-role="page" data-theme="c">
	...
	<div data-role="main">
    	...
    	<div style="width:100%;height:auto;float:left;padding-top:40px;">
        	<div style="width:30%;height:1px;float:left;">
        	</div>
        ...
        <div style="width:100%;height:auto;float:left;padding-top:40px;">
            ...
            <div style="width:40%;height:auto;float:left;text-align:center;">
                ...
                <div style="width:100%;height:auto;float:left;">   
                    ...
                    <div style="width:32%;height:auto;float:left;font-size: 4vw;">  
                    		 <div style="width:100%;height:10%;float:left;"></div>
                             
                             <div style="width:100%;height:80%;float:left;border: 2px solid black;border-radius: 15%;">
                             	<div style="width:100%;height:60%;float:left;text-align: center;"><span><strong>25</strong></span></div>
                             	<div style="width:100%;height:40%;float:left;text-align: center;"><span>HITS</span></div>   	
                             </div>
        ...
        <div style="width:100%;height:auto;float:left;padding-top: 35px;">
            ...
            <div style="width:40%;height:auto;float:left;">
                ...
                <div style="width:80%;height:1px;float:left;text-align: center;"><span>Join me to learn the steps to keep diabetes in check</span></div>            	
                <div style="width:10%;height:1px;float:left;"></div>
            </div>
            <div style="width:30%;height:1px;float:left;"></div>
        </div>
        
        <div style="width:100%;height:auto;float:left;padding-top: 115px;">
        	<div style="width:30%;height:1px;float:left;"></div>
            <div style="width:40%;height:auto;float:left;">
            	<!--<div style="width:100%;height:auto;float:left;">-->
                	<div style="width:50%;height:auto;float:left;background-color:#006ea0;color:white;text-align:center;">
                    	<span style="font-size: 3.2vw;">SHARE</span>
                	</div>
                    <div style="width:50%;height:auto;float:left;background-color:#0089c8;color:white;text-align:center;">
